...
$stmt_query = $query_webp ?
  'SELECT product_id as pid, name, webp_imgs as imgs, colors, sizes, unitPrice as price FROM products WHERE product_id = ?' :
  'SELECT product_id as pid, name, imgs, colors, sizes, unitPrice as price FROM products WHERE product_id = ?';
try {
